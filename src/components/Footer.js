    ...
    <section className="w-full py-12 md:py-24 lg:py-32 rounded-lg border border-[#383838] bg-[#242424]">
      <div className="container px-4 md:px-6 flex flex-col items-center text-center">
        ...
        <div className="flex justify-center space-x-4">
          <Link href="https://www.instagram.com/olof_hag/" aria-label="Instagram profile" className="text-white" prefetch={false}>
            <InstagramIcon className="h-6 w-6" />
          </Link>
          <Link href="https://www.linkedin.com/in/olof-hag" aria-label="LinkedIn profile" className="text-white" prefetch={false}>
